...
class Char(object):
    ...
    def assets(self):
        ...
        """
        raw_api_result = self.api.get('char/AssetList',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)

        result = parse_assets(api_result)
    ...
    def contract_bids(self):
        ...
        raw_api_result = self.api.get('char/ContractBids',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)

        result = parse_contract_bids(api_result)
        return self.api.format_result(raw_api_result, result)

    def contract_items(self, contract_id):
        """Lists items that a specified contract contains"""
        raw_api_result = self.api.get('char/ContractItems',
            {'characterID': self.char_id, 'contractID': contract_id})
        api_result = api.get_result_node(raw_api_result)

        result = parse_contract_items(api_result)
        return self.api.format_result(raw_api_result, result)

    def contracts(self):
        """Returns a record of all contracts for a specified character"""
        raw_api_result = self.api.get('char/Contracts',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)

        result = parse_contracts(api_result)
        return self.api.format_result(raw_api_result, result)
    ...
    def wallet_journal(self, before_id=None, limit=None):
        ...
        raw_api_result = self.api.get('char/WalletJournal', params)
        api_result = api.get_result_node(raw_api_result)

        result = parse_wallet_journal(api_result)
        return self.api.format_result(raw_api_result, result)

    def wallet_info(self):
        """Return a given character's wallet."""
        raw_api_result = self.api.get('char/AccountBalance',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def wallet_balance(self):
        ...
        result, reformat = self.api.format_result.unformat(self.wallet_info())
        return reformat(result['balance'])
    ...
    def wallet_transactions(self, before_id=None, limit=None):
        ...
        if limit is not None:
            params['rowCount'] = limit
        raw_api_result = self.api.get('char/WalletTransactions', params)
        api_result = api.get_result_node(raw_api_result)

        result = parse_wallet_transactions(api_result)
        return self.api.format_result(raw_api_result, result)

    def industry_jobs(self):
        """Get a list of jobs for a character"""

        raw_api_result = self.api.get('char/IndustryJobs',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)

        result = parse_industry_jobs(api_result)
        return self.api.format_result(raw_api_result, result)
    ...
    def kills(self, before_kill=None):
        ...
        raw_api_result = self.api.get('char/KillLog', params)
        api_result = api.get_result_node(raw_api_result)

        result = parse_kills(api_result)
        return self.api.format_result(raw_api_result, result)

    def notifications(self):
        """Returns the message headers for notifications."""
        raw_api_result = self.api.get('char/Notifications',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def notification_texts(self, notification_ids):
        ...
        raw_api_result = self.api.get('char/NotificationTexts',
    ...
    def standings(self):
        ...
        raw_api_result = self.api.get('char/Standings',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def character_sheet(self):
        ...
        raw_api_result = self.api.get('char/CharacterSheet',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def contacts(self):
        ...
        raw_api_result = self.api.get('char/ContactList',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)

        result = parse_contact_list(api_result)
        return self.api.format_result(raw_api_result, result)

    def orders(self):
        """Return a given character's buy and sell orders."""
        raw_api_result = self.api.get('char/MarketOrders',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)

        result = parse_market_orders(api_result)
        return self.api.format_result(raw_api_result, result)

    def research(self):
        """Returns information about the agents with whom the character is doing research."""

        raw_api_result = self.api.get('char/Research',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def current_training(self):
        ...
        raw_api_result = self.api.get('char/SkillInTraining',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def skill_queue(self):
        ...
        raw_api_result = self.api.get('char/SkillQueue',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def messages(self):
        ...
        raw_api_result = self.api.get('char/MailMessages',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
        ...
        return self.api.format_result(raw_api_result, results)
    ...
    def message_bodies(self, message_ids):
        ...
        """
        raw_api_result = self.api.get('char/MailBodies',
    ...
    def mailing_lists(self):
        ...
        raw_api_result = self.api.get('char/MailingLists')
        api_result = api.get_result_node(raw_api_result)
    ...
    def calendar_events(self):
        ...
        raw_api_result = self.api.get('char/UpcomingCalendarEvents',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def calendar_attendees(self, event_ids):
        ...
        """
        raw_api_result = self.api.get('char/CalendarEventAttendees',
        ...
        for row in rowset.findall('row'):
            ...
            target = results.get(int(a['eventID']))
            if target is None:
                continue
            target[attendee['id']] = attendee
    ...
    def event_attendees(self, event_id):
        ...
        (using the 'calendar_events' method) before calling this method.
        """
        result, reformat = self.api.format_result.unformat(
            self.calendar_attendees([event_id]))

        return reformat(result[int(event_id)])
    ...
    def faction_warfare_stats(self):
        ...
        """
        raw_api_result = self.api.get('char/FacWarStats',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def medals(self):
        ...
        raw_api_result = self.api.get('char/Medals',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def contact_notifications(self):
        ...
        raw_api_result = self.api.get('char/ContactNotifications',
            {'characterID': self.char_id})
        api_result = api.get_result_node(raw_api_result)
    ...
    def locations(self, location_list):
        ...
        raw_api_result = self.api.get('char/Locations', params)
        api_result = api.get_result_node(raw_api_result)
        rowset = api_result.find('rowset')
        rows = rowset.findall('row')
